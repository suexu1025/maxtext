...
python3 MaxText/train.py MaxText/configs/base.yml run_name=1xv3-8 save_period=5 ici_data_parallelism=4 ici_tensor_parallelism=2 steps=20 enable_profiler=true remat_policy=full base_emb_dim=512 base_num_heads=64 head_dim=64 vocab_size=50272 base_num_decoder_layers=1 per_device_batch_size=0.5 base_mlp_dim=2048 file_pattern_for_train_data="gs://yejingxin-us-central2/external/lg/dummy-data/train/*.tfrecords" file_pattern_for_eval_data="gs://yejingxin-us-central2/external/lg/dummy-data/valid/*tfrecords" enable_profiler=true base_output_directory="gs://mazumdera-test-bucket/maxtext/lg/10052023/4" dataset_type="lg" max_predict_length=512
# TFLOP/s 165, 22B
